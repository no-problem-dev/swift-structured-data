...
- **DateCodingStrategy** ✅ 完了（.iso8601 / .iso8601WithFractional / .secondsSince1970 / .millisecondsSince1970 / .llmAPIDefault / .custom。既定 .deferredToDate で非破壊。通信層が Foundation コーダから structured-data へ移行する前提）
- **Phase 4 — 既存実装の移行** — 進行中
